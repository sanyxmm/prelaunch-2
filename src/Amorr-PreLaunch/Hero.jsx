...
const Hero = () => {
  ...
  return (
    <div style={{ backgroundSize: "100% 100%" }} className='bg-couple bg-cover bg-no-repeat bg-center h-[100vh] w-full'>
      ...
      />
       <div
      className={`absolute bottom-[30%] left-[50%] text-center text-black text-[0.4rem] transform -translate-x-1/2 -translate-y-1/2 transition-all duration-[2500ms] ease-out ${
        animate2 ? "bottom-[70%] left-[50%] text-[2.5vw] " : ""
      }`}
    >
